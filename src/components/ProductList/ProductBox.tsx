...
const ProductBox: React.FC<IUnescoObjestProps> = ({
    ...
    const { selectItemIndex, setSelectItemIndex, setShowModal } =
        useGlobalContext()
            ...
            >
                <div className="image relative">
                    {image ? (
                        ...
                        <div className="blankImage flex">Brak obrazka</div>
                    )}
                    {/* <div className="star">

            ...
            <footer className="footer relative">
                <div className="container flex flexJustifyBetween flexAlignCenter">
                    ...
                    <ul className="social">
                        <li>
                            <Link
                                href="https://www.instagram.com/findunesco"
                                target="_blank"
                            >
                                <svg
                                    width="28"
                    ...
                    <ul className="flexJustifyEnd hiddenXs">
                        {/* <li>
                            <a href="/">English</a>
                        </li>
                        <li>
